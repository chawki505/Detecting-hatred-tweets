...
class StartHandler(tornado.web.RequestHandler, ABC):
    def get(self):
...
class PredictHandler(tornado.web.RequestHandler, ABC):
    def get(self):
    ...
    def post(self):
        ...
        self.render("res/output.html", tweet=tweet, predict_nb=predict_nb, predict_knn=predict_knn,
